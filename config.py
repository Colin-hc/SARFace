...
def get_args():
    ...
    parent_parser.add_argument('--lr',help='learning rate',default=3e-4, type=float)
    ...
    parent_parser.add_argument('--start_from_model_statedict', type=str, default='experiments/ir50_ms1mv2_adaface_08-09__________19/last.ckpt')
...
def add_task_arguments(parser):
    ...
    parser.add_argument('--head', default='cosface', type=str)
