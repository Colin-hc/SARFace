...
if __name__ == '__main__':
    ...
    parser.add_argument("-r", "--rec_path", help="mxnet record file path", default='/media/cdzs/94fe807a-5ba6-4f85-8ea3-f00bb3b97f4e/home/cdzs/data/faces_emore', type=str)
